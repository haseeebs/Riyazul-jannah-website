...
const OfferCard = ({ title, description, icon }) => (
  <div className="bg-white rounded-xl shadow-md p-6 border border-lime-500">
    <div className="flex items-center mb-4">
      <div className="bg-lime-100 rounded-full p-3 mr-4">{icon}</div>
...
const UniquePackages = () => {
  ...
  console.log(uniquePackages[0].image);
  console.log(packageServices.getFilePreview(uniquePackages[0].image));
  return (
