      ...
      <div className={`relative w-full min-h-screen`}>
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img
            ...
            src={packageServices.getFilePreview("6853c3ec0008c5e1b847")}
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className="py-24 md:py-32 lg:py-40 lg:pt-52 lg:pb-30 max-w-[800px]">
            ...
            <p className="text-lg md:text-xl text-white text-opacity-90 mb-8 max-w-[600px]">
              Complete Care, Peaceful Travel, and Trusted Guidance for Your
              Umrah Journey — Backed by Over 10 Years of Experience.
            </p>
